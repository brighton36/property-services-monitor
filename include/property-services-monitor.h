...
#define RESULT_TUPLE std::tuple<std::shared_ptr<std::vector<std::string>>, std::shared_ptr<nlohmann::json>>
...
unsigned int duration_to_seconds(std::string);
float percent_string_to_float(std::string);
